 ...
 */
final class Version20240124083103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE pen (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, material_id INT NOT NULL, brand_id INT NOT NULL, name VARCHAR(20) NOT NULL, price DOUBLE PRECISION NOT NULL, description VARCHAR(100) NOT NULL, ref VARCHAR(10) NOT NULL, UNIQUE INDEX UNIQ_193062FF146F3EA3 (ref), INDEX IDX_193062FFC54C8C93 (type_id), INDEX IDX_193062FFE308AC6F (material_id), INDEX IDX_193062FF44F5D008 (brand_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
